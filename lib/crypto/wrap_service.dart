...
class WrapService {
  ...
  // Cifra la DEK per un destinatario (x25519 + hkdf + aes-gcm).
  // Il blocco JSON risultante va in manifest.wraps.recipients[recipientId].
  ...
  // Decifra la DEK da un recipient wrap (lato destinatario).
